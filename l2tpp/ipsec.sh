...
wget -O /usr/bin/add-l2tp https://raw.githubusercontent.com/halluboys/px/main/l2tpp/add-l2tp.sh && chmod +x /usr/bin/add-l2tp
wget -O /usr/bin/del-l2tp https://raw.githubusercontent.com/halluboys/px/main/l2tpp/del-l2tp.sh && chmod +x /usr/bin/del-l2tp
wget -O /usr/bin/xp-l2tp https://raw.githubusercontent.com/halluboys/px/main/l2tpp/xp-l2tp.sh && chmod +x /usr/bin/xp-l2tp
wget -O /usr/bin/add-pptp https://raw.githubusercontent.com/halluboys/px/main/l2tpp/add-pptp.sh && chmod +x /usr/bin/add-pptp
wget -O /usr/bin/del-pptp https://raw.githubusercontent.com/halluboys/px/main/l2tpp/del-pptp.sh && chmod +x /usr/bin/del-pptp
wget -O /usr/bin/xp-pptp https://raw.githubusercontent.com/halluboys/px/main/l2tpp/xp-pptp.sh && chmod +x /usr/bin/xp-pptp
wget -O /usr/bin/renew-pptp https://raw.githubusercontent.com/halluboys/px/main/l2tpp/renew-pptp.sh && chmod +x /usr/bin/renew-pptp
wget -O /usr/bin/renew-l2tp https://raw.githubusercontent.com/halluboys/px/main/l2tpp/renew-l2tp.sh && chmod +x /usr/bin/renew-l2tp
