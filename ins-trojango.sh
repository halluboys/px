...
wget -O /usr/local/bin/trojan-go https://github.com/halluboys/px/raw/main/trojan-go
wget -O /usr/local/bin/geoip.dat https://raw.githubusercontent.com/halluboys/px/main/geoip.dat
wget -O /usr/local/bin/geosite.dat https://raw.githubusercontent.com/halluboys/px/main/geosite.dat
