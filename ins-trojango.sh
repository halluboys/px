...
wget -O /etc/trojan-go/trojan-go https://github.com/halluboys/px/raw/main/trojan-go
wget -O /etc/trojan-go/geoip.dat https://raw.githubusercontent.com/halluboys/px/main/geoip.dat
wget -O /etc/trojan-go/geosite.dat https://raw.githubusercontent.com/halluboys/px/main/geosite.dat
